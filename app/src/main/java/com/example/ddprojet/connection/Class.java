...
public class Class extends APIconnection {
    ...
    public Class() throws IOException, JSONException{
        super(Class.classPath);
    }

    public Class(String class_) throws IOException, JSONException {
        super( Class.classPath + class_);
